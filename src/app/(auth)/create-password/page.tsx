...
function CreatePasswordForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    try {
      await apiClient.post(ENDPOINTS.auth.createPassword, {
      ...
      const msg = err?.message || "Failed to set password. Link may have expired.";
      ...
      <Card className="bg-transparent text-card-foreground p-lg border-none shadow-none ring-0">
        <CardHeader className="text-center pb-md">
          ...
          <CardDescription className="text-paragraph-sm text-neutral-500 mt-sm">
            The link you followed has expired or is invalid. Please request a new invitation link or contact your system Administrator or Manager.
          </CardDescription>
        </CardHeader>
    ...
    <Card className="bg-transparent text-card-foreground p-lg border-none shadow-none ring-0">
      <CardHeader className="text-center pb-md">
        ...
        <CardDescription className="text-paragraph-sm text-neutral-400">
          Setup credentials for your new VIEMS account.
        </CardDescription>
      </CardHeader>
      <CardContent>
